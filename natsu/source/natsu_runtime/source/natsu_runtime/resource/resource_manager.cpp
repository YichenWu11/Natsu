...
namespace Natsu::Runtime {
    ...
    struct TResourceManager : public IResourceManager {
        ...
        void add(std::unique_ptr<IResource>&& resource, size_t uuid) override {
    ...
    ResourceManager::ResourceManager() {
        m_managers.emplace(ResourceType::Texture, std::make_unique<TResourceManager<ResourceType::Texture>>());
        m_managers.emplace(ResourceType::Mesh, std::make_unique<TResourceManager<ResourceType::Mesh>>());
    }
